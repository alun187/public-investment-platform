package com.cuidl.pip.sms.service.impl;
...
public class SmsServiceImpl implements ISmsService {
    ...
    public void send(String mobile, String templateCode, Map<String, Object> param) {
        ...
        try {
            ...
            Asserte.isTrue(success, ResponseEnum.ALIYUN_RESPONSE_FAIL);
            ...
            Asserte.notEquals("isv.BUSINESS_LIMIT_CONTROL", code, ResponseEnum.ALIYUN_SMS_LIMIT_CONTROL_ERROR);
            //ALIYUN_SMS_ERROR(-503, "短信发送失败"),//其他失败
            Asserte.equals("OK", code, ResponseEnum.ALIYUN_SMS_ERROR);
